...
def create_app():
    ...
    uvicorn.run(app, host="0.0.0.0", port=app_port, log_level="debug", log_config=LOGGING)
...
async def http_exception_handler(request: Request, ex: StartletteHTTPException):
